...
function AddServiceRoom({ isOpen, onClose, fetchData }) {
    ...
    const handleAdd = async () => {
        ...
        try {
            const response = await adminApi.addServieRoom(accessToken, formData);
            if (response.data.statusCode === 200) {
                fetchData();
                Swal.fire({
                    title: 'Thành công!',
                    text: 'Dịch vụ phòng đã được thêm thành công.',
                    icon: 'success',
                    confirmButtonText: 'OK'
                });
                onClose();
            ...
            console.error('Error adding service room:', error);
            Swal.fire({
                title: 'Lỗi!',
                text: 'Có lỗi xảy ra khi thêm dịch vụ phòng. Vui lòng thử lại.',
                icon: 'error',
                confirmButtonText: 'OK'
            });
        }
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl relative">
                ...
                <div className="text-xl font-inter font-semibold mb-4">Thêm dịch vụ phòng</div>
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="mt-5">
                            <h2 className="font-semibold text-lg">Biểu tượng đã chọn:</h2>
                            {image ? (
