...
import { faInfoCircle, faShoppingCart, faHistory } from '@fortawesome/free-solid-svg-icons';
...
import BookingServiceHistory from "../BookingServiceHistory/BookingServiceHistory";

function ManageBooking() {
    const [activeTab, setActiveTab] = useState('booking'); // 'booking', 'history', or 'service-history'
                    ...
                    <div className="w-full flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex gap-2">
                                <button
                                    className={`px-4 py-2 rounded-md font-semibold ${activeTab === 'booking' ? 'bg-yellow-500 text-white' : 'bg-gray-200'}`}
                                    onClick={() => setActiveTab('booking')}
                                >
                                    Đặt phòng
                                </button>
                                <button
                                    className={`px-4 py-2 rounded-md font-semibold ${activeTab === 'history' ? 'bg-yellow-500 text-white' : 'bg-gray-200'}`}
                                    onClick={() => setActiveTab('history')}
                                >
                                    Lịch sử đặt phòng
                                </button>
                                <button
                                    className={`px-4 py-2 rounded-md font-semibold ${activeTab === 'service-history' ? 'bg-yellow-500 text-white' : 'bg-gray-200'}`}
